...
const GestionBajas = () => {
  ...
  // ✅ estado actual para saber si está ocupado
  ...
  // ✅ separo cargas: base (productos/departamentos) y ocupados (asignaciones)
  ...
  // ✅ ahora retorna data para validaciones (evita estado stale)
  ...
  // ✅ map/set de productos ocupados (para UI)
  ...
  const darDeBajaProducto = async () => {
    ...
    const confirm = await Swal.fire({
      ...
      text: "Este bien pasará a estado INACTIVO y quedará registrado en el historial.",
      icon: "warning",
